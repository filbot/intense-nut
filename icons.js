...
(function(){
  ...
  const ICONS = {
    ...
    chipotle(c){ return `<path d="M13 35 C15 27 21 18 33 13" stroke="${c.ink}" stroke-width="12" stroke-linecap="round" fill="none"/>
      <path d="M17 31 q3 1 5 -1 M22 24 q3 1 5 -1" stroke="${c.paper}" stroke-width="1.5" fill="none" opacity="0.8"/>
      <path d="M33 13 C35 10 39 8.5 42 10" stroke="${c.accent}" stroke-width="3.5" stroke-linecap="round" fill="none"/>`; },
